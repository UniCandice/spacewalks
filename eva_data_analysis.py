...
def main(eva_data_file, eva_csv_file, graph_file):
    # Read the data from JSON file
    eva_data = read_json_to_dataframe(eva_data_file)

    # Convert and export data to CSV file
    write_dataframe_to_csv(eva_data, eva_csv_file)
...
if __name__ == "__main__":
    ...
    if len(sys.argv) <3:
        ...
        print (f"No command line arguments provided, using default file paths: {input_file}, {output_file}")
